import image1 from '@/common/images/sample-image.jpg'
import image2 from '@/common/images/shutterbug.jpg'
            ...
            <div id="content-wrap" className="styles">
                ...
                <div className="row">
                    <div className="col-six tab-full">
                        ...
                        <p><a href="#"><img width="120" height="120" className="pull-left" alt="sample-image" src={image1.src}/></a>
                ...
                <div className="row">
                    <div className="col-six tab-full">
                        ...
                        <form>
                            ...
                            <input className="button-primary full-width-on-mobile" type="submit" defaultValue="Submit"/>
                        </form>
                    </div>
                    <div className="col-six tab-full">
                        <h3>Code Block</h3>
